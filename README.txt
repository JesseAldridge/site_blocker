...
---
Clone the repo
Set the blacklist and whitelist by editing the list in `background.js`.  (All urls containing a term in the blacklist will be blocked unless they also contain a term in the whitelist.)
In Chrome, click the three dots button on the top right -> More Tools -> Extensions
...
You can manually unblock sites by disabling and enabling the extension.  (Right click the extension button -> Manage extensions -> click "Enabled" checkbox twice)
